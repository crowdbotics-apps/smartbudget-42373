"""
Django settings for smartbudget_42373 project.
...
ROOT_URLCONF = 'smartbudget_42373.urls'
...
WSGI_APPLICATION = 'smartbudget_42373.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "smartbudget_42373 API",
    "DESCRIPTION": "API documentation for smartbudget_42373 App",
    "VERSION": "v1",
}
